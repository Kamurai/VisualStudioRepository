...
Begin VB.Form frmA 
   ...
   Begin VB.CommandButton btnAHS 
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnAGDShow 
      ...
      Width           =   2175
   End
   Begin VB.CommandButton btnAHQ2 
      Caption         =   "HQ2"
      Height          =   315
      Left            =   480
      TabIndex        =   2
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnAHQ1 
      Caption         =   "HQ1"
      Height          =   315
      Left            =   480
      TabIndex        =   1
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnAARYMYDone 
      Caption         =   "Done"
      Height          =   255
      Left            =   3840
      TabIndex        =   0
...
Private Sub btnAARYMYDone_Click()
frmA.Hide
End Sub


Private Sub btnAGDShow_Click()
Load frmGeneralDisplay
frmGeneralDisplay.Show
End Sub

Private Sub btnAHQ1_Click()
Load frmAHQ1
frmAHQ1.Show
End Sub

Private Sub btnAHQ2_Click()
Load frmAHQ2
frmAHQ2.Show
End Sub

Private Sub btnAT_Click()
Load frmAT
frmAT.Show
End Sub
...
Private Sub btnAFA_Click()
Load frmAFA
frmAFA.Show
End Sub

Private Sub btnAHS_Click()
Load frmAHS
frmAHS.Show
End Sub
