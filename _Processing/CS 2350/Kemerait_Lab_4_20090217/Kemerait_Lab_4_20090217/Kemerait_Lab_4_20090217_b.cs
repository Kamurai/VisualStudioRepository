    ...
    class Kemerait_Lab_4_20090217
    {
        ...
        static void CarpetShopping()
        {
            ...
            */
            ...
            int roomnameprices = 1;
            //Length
            int roomlength = 3;
            //Width
            int roomwidth = 4;
            //Length by Width
            int roomdimensions = 5;
            ...
            //attributes of room in a multi-dimesional array, restricted by the number of rooms, number of attributes
            object[,] room = new object[limit, 7];
            ...
            for (int x = 0; x < limit; x++)
            {
                ...
                room[x, roomwidth] = input2 + (12 * input1);
                ...
                room[x, roomlength] = input2 + (12 * input1);

                //obtain room dimensions (= wdith * length)
                room[x, roomdimensions] = Convert.ToDouble(room[x, roomwidth]) * Convert.ToDouble(room[x, roomlength]);
            ...
            if (berbers <= piles)
            {
                ...
                for (int y = 0; y < berbers; y++)
                {
                    ...
                    {
                        input2 = Convert.ToDouble(room[0, roomdimensions]);
                        input1 = 0;
                    }
                    ...
                    for (int x = 0; x < limit; x++)
                    {
                        ...
                        {
                            if (Convert.ToDouble(room[x, roomdimensions]) < input2)
                            {
                                //if this is the last number
                                if ((x + 1) == limit)
                                {
                    ...
                    room[Convert.ToInt32(input1), roomname] = carpets[0, 0];
                    //assign current room to respective price per sq yd
                    room[Convert.ToInt32(input1), roomnameprices] = carpets[1, 0];
                }
                ...
                for (int x = 0; x < limit; x++)
                {
                    ...
                    else
                    {
                        ...
                        room[x, roomname] = carpets[0, 1];
                        //assign current room to respective price per sq yd
                        room[x, roomnameprices] = carpets[1, 1];
                    }
                }
            ...
            else if (berbers > piles)
            {
                ...
                for (int y = 0; y < piles; y++)
                {
                    ...
                    if (room[y, roomname].Equals(carpets[0, 1]))
                    {
                        //Look for the next unassigned room
                        for (int x = 0; x < limit; x++)
                        {
                    ...
                    for (int x = 0; x < limit; x++)
                    {
                        ...
                        if (room[x, roomname].Equals(carpets[0, 1]))
                        {
                        }
                        else
                        {
                    ...
                    room[Convert.ToInt32(input1), roomname] = carpets[0, 1];
                    room[Convert.ToInt32(input1), roomnameprices] = carpets[1, 1];
                }
                ...
                for (int x = 0; x < limit; x++)
                {
                    ...
                    {
                        room[x, roomname] = carpets[0, 0];
                        room[x, roomnameprices] = carpets[1, 0];
            ...
            for(int x = 0; x < limit; x++)
            {
                ...
                room[x, roomprices] = (Convert.ToDouble(room[x, roomdimensions])/1296) * Convert.ToDouble(room[x, roomnameprices]);
            }
            ...
            for (int x = 0; x < limit; x++)
            {
                ...
                System.Console.Write("The room with size {0:f2} feet by {1:f2} feet should have {2:0} carpet\nat {3:c2} per square yard for {4:f2} square yards,\nyielding a total price of: {5:c2}.\n\n", (Convert.ToDouble(room[x, roomwidth])/12), (Convert.ToDouble(room[x, roomlength])/12), room[x, roomname], room[x, roomnameprices], (Convert.ToDouble(room[x, roomdimensions])/1296), room[x, roomprices]);
            }
            ...
            for (int x = 0; x < limit; x++)
            {
                input1 = input1 + (Convert.ToDouble(room[x, roomdimensions])/1296);
                input2 = input2 + Convert.ToDouble(room[x, roomprices]);
            }
            //output totals
