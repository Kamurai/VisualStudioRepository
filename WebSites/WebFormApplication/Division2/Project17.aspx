<%@ Page Title="Goblins and Guardians" Language="C#" MasterPageFile="~/Division2/Template.master" AutoEventWireup="true"
    CodeFile="Project17.aspx.cs" Inherits="_Project2_17" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
	...
	<div id="idCenterContent">
		This section is dedicated to the board game project "Goblins and Guardians".
...
<asp:Content ID="VersionContent" runat="server" ContentPlaceHolderID="VersionContent">
	...
	<a href="http://htkb.dyndns.org/Javascript/Division2/Project17.html">HTML Javascript</a></br>
	...
	<a href="http://htkb.dyndns.org:81/MVC/Main/Division2/Project17">ASP.NET MVC App</a></br>
