<%@ Page Title="Truth" Language="C#" MasterPageFile="~/Section2/Template.master" AutoEventWireup="true"
    CodeFile="Project6.aspx.cs" Inherits="_Project2_7" %>
...
<asp:Content ID="VersionContent" runat="server" ContentPlaceHolderID="VersionContent">
	...
	<a href="http://htkb.dyndns.org:81/MVC/Section2/Project7">ASP.NET MVC App</a></br>
