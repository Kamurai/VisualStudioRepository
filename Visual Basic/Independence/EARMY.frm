...
Begin VB.Form frmE 
   ...
   Begin VB.CommandButton btnEHS 
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnEGDShow 
      ...
      Width           =   2175
   End
   Begin VB.CommandButton btnEHQ2 
      Caption         =   "HQ2"
      Height          =   315
      Left            =   480
      TabIndex        =   2
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnEHQ1 
      Caption         =   "HQ1"
      Height          =   315
      Left            =   480
      TabIndex        =   1
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnEARYMYDone 
      Caption         =   "Done"
      Height          =   255
      Left            =   3840
      TabIndex        =   0
...
Private Sub btnEARYMYDone_Click()
frmE.Hide
End Sub


Private Sub btnEGDShow_Click()
Load frmGeneralDisplay
frmGeneralDisplay.Show
End Sub

Private Sub btnEHQ1_Click()
Load frmEHQ1
frmEHQ1.Show
End Sub

Private Sub btnEHQ2_Click()
Load frmEHQ2
frmEHQ2.Show
End Sub

Private Sub btnET_Click()
Load frmET
frmET.Show
End Sub

Private Sub btnEE_Click()
Load frmEE
frmEE.Show
End Sub

Private Sub btnEFA_Click()
Load frmEFA
frmEFA.Show
End Sub

Private Sub btnEHS_Click()
Load frmEHS
frmEHS.Show
End Sub
