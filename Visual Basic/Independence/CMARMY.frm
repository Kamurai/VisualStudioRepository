...
Begin VB.Form frmCM 
   ...
   Begin VB.CommandButton btnCME 
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnCMFA 
      Caption         =   "Fast Attack"
      Height          =   315
      Left            =   480
      TabIndex        =   5
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnCMHS 
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnCMGDShow 
      ...
      Width           =   2175
   End
   Begin VB.CommandButton btnCMHQ2 
      Caption         =   "HQ2"
      Height          =   315
      Left            =   480
      TabIndex        =   2
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnCMHQ1 
      Caption         =   "HQ1"
      Height          =   315
      Left            =   480
      TabIndex        =   1
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnCMARYMYDone 
      Caption         =   "Done"
      Height          =   255
      Left            =   3840
      TabIndex        =   0
...
Private Sub btnCMARYMYDone_Click()
frmCM.Hide
End Sub


Private Sub btnCMGDShow_Click()
Load frmGeneralDisplay
frmGeneralDisplay.Show
End Sub

Private Sub btnCMHQ1_Click()
Load frmCMHQ1
frmCMHQ1.Show
End Sub

Private Sub btnCMHQ2_Click()
Load frmCMHQ2
frmCMHQ2.Show
End Sub

Private Sub btnCMT_Click()
Load frmCMT
frmCMT.Show
End Sub

Private Sub btnCME_Click()
Load frmCME
frmCME.Show
End Sub

Private Sub btnCMFA_Click()
Load frmCMFA
frmCMFA.Show
End Sub

Private Sub btnCMHS_Click()
Load frmCMHS
frmCMHS.Show
End Sub
