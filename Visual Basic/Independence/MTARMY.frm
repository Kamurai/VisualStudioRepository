VERSION 5.00
Begin VB.Form frmMT 
   Caption         =   "Marines of the Twinfist Army"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   ...
   Begin VB.CommandButton btnMTE 
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnMTFA 
      Caption         =   "Fast Attack"
      Height          =   315
      Left            =   480
      TabIndex        =   5
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnMTHS 
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnMTGDShow 
      ...
      Width           =   2175
   End
   Begin VB.CommandButton btnMTHQ2 
      Caption         =   "HQ2"
      Height          =   315
      Left            =   480
      TabIndex        =   2
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnMTHQ1 
      Caption         =   "HQ1"
      Height          =   315
      Left            =   480
      TabIndex        =   1
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnMTARYMYDone 
      Caption         =   "Done"
      Height          =   255
      Left            =   3840
      TabIndex        =   0
...
Private Sub btnMTARYMYDone_Click()
frmMT.Hide
End Sub


Private Sub btnMTGDShow_Click()
Load frmGeneralDisplay
frmGeneralDisplay.Show
End Sub

Private Sub btnMTHQ1_Click()
Load frmMTHQ1
frmMTHQ1.Show
End Sub

Private Sub btnMTHQ2_Click()
Load frmMTHQ2
frmMTHQ2.Show
End Sub

Private Sub btnMTT_Click()
Load frmMTT
frmMTT.Show
End Sub

Private Sub btnMTE_Click()
Load frmMTE
frmMTE.Show
End Sub

Private Sub btnMTFA_Click()
Load frmMTFA
frmMTFA.Show
End Sub

Private Sub btnMTHS_Click()
Load frmMTHS
frmMTHS.Show
End Sub
