VERSION 5.00
Begin VB.Form frmSpaceMarinesHeavySupport 
   Caption         =   "Space Marines Heavy Support"
   ClientHeight    =   3570
   ClientLeft      =   165
   ClientTop       =   780
   ClientWidth     =   6345
   ...
   End
End
Attribute VB_Name = "frmSpaceMarinesHeavySupport"
...
Private Sub DisplayHeavySupport()
'Initialize Total
    Squad(15, ActiveArmy) = Group(1, 15, ActiveArmy) + Group(2, 15, ActiveArmy) + Group(3, 15, ActiveArmy) + Group(4, 15, ActiveArmy) + Group(5, 15, ActiveArmy) + Group(6, 15, ActiveArmy) + Group(7, 15, ActiveArmy) + Group(8, 15, ActiveArmy) + Group(9, 15, ActiveArmy)
    Squad(16, ActiveArmy) = Group(1, 16, ActiveArmy) + Group(2, 16, ActiveArmy) + Group(3, 16, ActiveArmy) + Group(4, 16, ActiveArmy) + Group(5, 16, ActiveArmy) + Group(6, 16, ActiveArmy) + Group(7, 16, ActiveArmy) + Group(8, 16, ActiveArmy) + Group(9, 16, ActiveArmy)
    Squad(17, ActiveArmy) = Group(1, 17, ActiveArmy) + Group(2, 17, ActiveArmy) + Group(3, 17, ActiveArmy) + Group(4, 17, ActiveArmy) + Group(5, 17, ActiveArmy) + Group(6, 17, ActiveArmy) + Group(7, 17, ActiveArmy) + Group(8, 17, ActiveArmy) + Group(9, 17, ActiveArmy)
'Display
    picDisplay.Cls
    picDisplay.Print "Group"; Tab(13); "Points:"; Tab(20); "HS 1"; Tab(30); "HS 2"; Tab(40); "HS 3"
    picDisplay.Print "Sergeant"; Tab(20); Group(2, 15, ActiveArmy); Tab(30); Group(2, 16, ActiveArmy); Tab(40); Group(2, 17, ActiveArmy)
    picDisplay.Print "Squad Members"; Tab(20); Group(6, 15, ActiveArmy); Tab(30); Group(6, 16, ActiveArmy); Tab(40); Group(6, 17, ActiveArmy)
    picDisplay.Print "Assault Weaponry"; Tab(20); Group(7, 15, ActiveArmy); Tab(30); Group(7, 16, ActiveArmy); Tab(40); Group(7, 17, ActiveArmy)
    picDisplay.Print "Heavy Weaponry"; Tab(20); Group(8, 15, ActiveArmy); Tab(30); Group(8, 16, ActiveArmy); Tab(40); Group(8, 17, ActiveArmy)
    picDisplay.Print "Transport"; Tab(20); Group(9, 15, ActiveArmy); Tab(30); Group(9, 16, ActiveArmy); Tab(40); Group(9, 17, ActiveArmy)
    picDisplay.Print "Total"; Tab(20); Squad(15, ActiveArmy); Tab(30); Squad(16, ActiveArmy); Tab(40); Squad(17, ActiveArmy)
End Sub
...
frmSpaceMarinesHeavySupport.Hide
End Sub
