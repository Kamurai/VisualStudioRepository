...
Begin VB.Form frmGM 
   ...
   Begin VB.CommandButton btnGME 
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnGMFA 
      Caption         =   "Fast Attack"
      Height          =   315
      Left            =   480
      TabIndex        =   5
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnGMHS 
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnGMGDShow 
      ...
      Width           =   2175
   End
   Begin VB.CommandButton btnGMHQ2 
      Caption         =   "HQ2"
      Height          =   315
      Left            =   480
      TabIndex        =   2
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnGMHQ1 
      Caption         =   "HQ1"
      Height          =   315
      Left            =   480
      TabIndex        =   1
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnGMARYMYDone 
      Caption         =   "Done"
      Height          =   255
      Left            =   3840
      TabIndex        =   0
...
Private Sub btnGMARYMYDone_Click()
frmGM.Hide
End Sub

Private Sub btnGMGDShow_Click()
Load frmGeneralDisplay
frmGeneralDisplay.Show
End Sub

Private Sub btnGMHQ1_Click()
Load frmGMHQ1
frmGMHQ1.Show
End Sub

Private Sub btnGMHQ2_Click()
Load frmEHQ2
frmGMHQ2.Show
End Sub

Private Sub btnGMT_Click()
Load frmGMT
frmGMT.Show
End Sub

Private Sub btnGME_Click()
Load frmGME
frmGME.Show
End Sub

Private Sub btnGMFA_Click()
Load frmGMFA
frmGMFA.Show
End Sub

Private Sub btnGMHS_Click()
Load frmGMHS
frmGMHS.Show
End Sub
