VERSION 5.00
Begin VB.Form frmSB 
   Caption         =   "Sisters of Battle Army"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   ...
   Begin VB.CommandButton btnSBE 
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnSBFA 
      Caption         =   "Fast Attack"
      Height          =   315
      Left            =   480
      TabIndex        =   5
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnSBHS 
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnSBGDShow 
      ...
      Width           =   2175
   End
   Begin VB.CommandButton btnSBHQ2 
      Caption         =   "HQ2"
      Height          =   315
      Left            =   480
      TabIndex        =   2
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnSBHQ1 
      Caption         =   "HQ1"
      Height          =   315
      Left            =   480
      TabIndex        =   1
      ...
      Width           =   1215
   End
   Begin VB.CommandButton btnSBARYMYDone 
      Caption         =   "Done"
      Height          =   255
      Left            =   3840
      TabIndex        =   0
...
Private Sub btnSBARYMYDone_Click()
frmSB.Hide
End Sub


Private Sub btnSBGDShow_Click()
Load frmGeneralDsiplay
frmGeneralDisplay.Show
End Sub

Private Sub btnSBHQ1_Click()
Load frmSBHQ1
frmSBHQ1.Show
End Sub

Private Sub btnSBHQ2_Click()
Load frmSBHQ2
frmSBHQ2.Show
End Sub

Private Sub btnSBT_Click()
Load frmSBT
frmSBT.Show
End Sub

Private Sub btnSBE_Click()
Load frmSBE
frmSBE.Show
End Sub

Private Sub btnSBFA_Click()
Load frmSBFA
frmSBFA.Show
End Sub

Private Sub btnSBHS_Click()
Load frmSBHS
frmSBHS.Show
End Sub
